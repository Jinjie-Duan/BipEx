...
df_ucla_to_merge$PHENOTYPE_FINE_NEW[df_ucla_to_merge$PHENOTYPE_FINE_NEW %in%
	c("Bipolar disorder NOS", "Bipolar NOS")] <- "Bipolar Disorder"
...
df_car$PHENOTYPE_FINE_NEW[which(df_car$bp_nos == "1")] <- "Bipolar Disorder"
...
df_mgh$PHENOTYPE_FINE_NEW[which(df_mgh$bp_nos == "2")] <- "Bipolar Disorder"
...
df_mgh_to_merge$PHENOTYPE_FINE_NEW_CHECK[which(df_mgh_to_merge$BPTYPE_final == '3')] <- "Bipolar Disorder"
...
df_kl$PHENOTYPE_COARSE_NEW[which(df_kl$PHENOTYPE_FINE_NEW %in% c("Bipolar Disorder 1", "Bipolar Disorder 2", "Bipolar Disorder"))] <- "Bipolar Disorder" 
...
df_ger$PHENOTYPE_FINE_NEW[which(df_ger$PHENOTYPE_FINE_NEW == "Bipolar NOS")] <- "Bipolar Disorder"
...
merged_df$primary_disease_subtype[grep("Bipolar Disorder NOS", merged_df$primary_disease_subtype)] <- "Bipolar Disorder"
