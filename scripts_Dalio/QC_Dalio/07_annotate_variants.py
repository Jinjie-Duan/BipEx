...
# Grabbed the tsv of constraint information keyed by gene. Use this to annotate across genome builds.
constraint_ht = hl.read_table("gs://gnomad-public/release/2.1.1/constraint/gnomad.v2.1.1.lof_metrics.by_transcript.ht")
# I think I should be grabbing the per gene version of this.
...
# mt = mt.annotate_rows(gene_constraint = constraint_ht[mt.vep.worst_csq_for_variant_canonical.gene_symbol,  mt.vep.worst_csq_for_variant_canonical.transcript_id])
