...
FINAL_PRUNED_VARIANTS = 'gs://dalio_bipolar_w1_w2_hail_02/data/variants/17_prune.final_qc.keep.variant_list'

QC_MT = 'gs://dalio_bipolar_w1_w2_hail_02/data/mt/18_european.strict.mt'
QC_HARDCALLS_MT = 'gs://dalio_bipolar_w1_w2_hail_02/data/mt/18_european.strict.hardcalls.mt'

FINAL_VARIANT_QC_FILE = 'gs://dalio_bipolar_w1_w2_hail_02/data/variants/18_final_qc.variants.tsv.bgz'
FINAL_SAMPLE_QC_FILE = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/18_final_qc.samples.tsv.bgz'
...
ht_final_pruned_variants = ht_final_pruned_variants.annotate(**hl.parse_variant(ht_final_pruned_variants.f0))
...
mt = mt.annotate_rows(
	annotation = mt.annotation.annotate(
		info = mt.annotation.info.annotate(
			...
			MLEAC = mt.annotation.info.MLEAC[mt.annotation.a_index-1],
			MLEAF = mt.annotation.info.MLEAF[mt.annotation.a_index-1])
		)
	)
...
mt_rows.select(rsid = mt_rows.annotation.rsid,
	...
	most_severe_consequence = mt_rows.annotation.vep.most_severe_consequence,
	consequence_category = mt_rows.annotation.consequence_category,
	polyphen_prediction = mt_rows.annotation.gene_transcript.polyphen_prediction,
	sift_prediction = mt_rows.annotation.gene_transcript.sift_prediction,
	discovEHR_AF = mt_rows.annotation.discovEHR.info.AF,
