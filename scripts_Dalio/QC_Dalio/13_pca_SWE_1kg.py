...
PCA_SCORES_SWE_1KG = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/13_pca_scores.swedes.1kg.tsv'
...
SWEDES = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/12_swedes.sample_list'
...
ht_swedes = hl.import_table(SWEDES, no_header=True, key='f0')
...
mt = mt.filter_cols(hl.is_defined(ht_swedes[mt.col_key]))
...
pca_output.flatten().export(output=PCA_SCORES_SWE_1KG)
