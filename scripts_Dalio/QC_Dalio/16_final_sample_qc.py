...
SAMPLE_BEFORE_QC_FILE = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/16_final_qc.before.samples.tsv'
SAMPLE_AFTER_QC_FILE = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/16_final_qc.after.samples.tsv'
