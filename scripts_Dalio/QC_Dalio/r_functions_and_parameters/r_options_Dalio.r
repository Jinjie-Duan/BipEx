...
VARIANT_LIST <- '../../variants_Dalio/14_final_qc.keep.variant_list'
...
FINAL_SAMPLE_LIST <- '../../samples_Dalio/15_final_qc.keep.sample_list'
FINAL_SAMPLE_LIST_REMOVE_SINGLETON_OUTLIERS <- '../../samples_Dalio/15_final_qc_remove_singleton_outliers.keep.sample_list'
