...
PCA_SCORES_MAINLAND_EUR_1KG = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/13_pca_scores.mainland_european.1kg.tsv'
...
MAINLAND_EUROPEANS = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/12_mainland_european.sample_list'
...
ht_mainland_europeans = hl.import_table(MAINLAND_EUROPEANS, no_header=True, key='f0')
...
mt = mt.filter_cols(hl.is_defined(ht_mainland_europeans[mt.col_key]))
...
pca_output.flatten().export(output=PCA_SCORES_MAINLAND_EUR_1KG)
